...
describe('error.middleware', () => {
    ...
    it('should handle ApiError correctly', () => {
        ...
        errorMiddleware(apiError, mockRequest, mockResponse, mockNext);
    ...
    it('should handle Joi ValidationError correctly', () => {
        ...
        joiError.details = [{ path: ['email'], message: '"email" must be a valid email' }];
        errorMiddleware(joiError, mockRequest, mockResponse, mockNext);
        expect(logger.error).toHaveBeenCalledTimes(1);
